    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                ...
                const dummyToken = `token_${Date.now()}_${Math.random().toString(36).substring(2, 15)}`;
                ...
                console.log("Token saved:", dummyToken);
                router.push('/')
            ...
            <div className="mb-4">
                ...
                <div className="relative">
                    <input
                        ...
                        className={`w-full rounded-lg border ${formik.touched.email && formik.errors.email
                            ? "border-red-500"
                            : "border-stroke dark:border-dark-3"
                            } bg-transparent py-[15px] pl-6 pr-11 font-medium text-dark outline-none focus:border-primary focus-visible:shadow-none dark:bg-dark-2 dark:text-white dark:focus:border-primary`}
                    />
