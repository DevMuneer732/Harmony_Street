...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-9 flex w-full border-b border-stroke bg-white dark:border-stroke-dark dark:bg-gray-dark !mt-0">
      <div className="flex flex-grow items-center justify-between px-4 py-5 shadow-2 md:px-5 2xl:px-10">
        <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
          ...
          <button
            ...
            className="z-99999 block rounded-sm border border-stroke bg-white p-1.5 shadow-sm dark:border-dark-3 dark:bg-dark-2 lg:hidden !mt-0"
          >
